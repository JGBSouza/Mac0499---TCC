...
% Definição de estilo para diffs
\lstdefinelanguage{diff}{
  morecomment=[f][\color{gray}]{@@},      % linhas @@
  morecomment=[f][\color{red}]{-},        % linhas removidas
  morecomment=[f][\color{green!60!black}]{+}, % linhas adicionadas
  morecomment=[f][\color{blue}]{!},       % alterações
}
...
\title{Automatização do fluxo de submissões de patches para o kernel Linux através do kworkflow}%[um subtítulo]
\translatedtitle{Automating the Linux kernel patch submission flow using kworkflow}%[a subtitle]

\author{João Guilherme Barbosa de Souza}
...
\orientador{David de Barros Tadokoro}
...
\pagestyle{mainmatter}
\input{conteudo/01-kernel-linux}
\input{conteudo/02-kw}
\input{conteudo/03-trabalho-realizado}
\input{conteudo/04-consideracoes-finais}
%%%%%%%%%%%%%%%%%%%%%%%%%%%% APÊNDICES E ANEXOS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
